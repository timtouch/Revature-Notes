...
INSERT INTO CAR(C_ID) VALUES (1); /* Would not work */
...
/* Alias - AS  */
SELECT C_MAKE AS Make FROM CAR; /* Gives C_MAKE the Alias 'Make's*/
...
/* CAN USE +, -, *, / ON NUMERICS OR JOIN CHARACTERS WITH || */
SELECT C_YEAR * C_YEAR AS YEARSQUARED FROM CAR;

SELECT C_MAKE || C_MODEL AS MAKEMODEL FROM CAR;

INSERT INTO CAR VALUES (3, 'Toyota', 'RAV-4', 2019);
INSERT INTO CAR VALUES (4, 'Honda', 'CR-V', 2019);
...
SELECT MIN(C_YEAR), C_MAKE FROM CAR
    GROUP BY C_MAKE;
...
/* Without the WHERE clause, every row would update their C_YEAR */
...
SELECT C_MAKE, C_YEAR FROM CAR
    GROUP BY C_MAKE, C_YEAR
    ORDER BY C_YEAR;
